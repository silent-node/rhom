  ...
  run: async (client, message, args, cmduser, text, prefix, player, es, ls) => {
    let tempmsg = await message.reply({
      embeds: [new MessageEmbed()
        .setColor(es.color)
        .setAuthor(handlemsg(client.la[ls].cmds.info.commandcount.tempmsg)
      ]
    })
    let lines = 0
    let letters = 0
...
/**
 * @INFO
 * Bot Coded by Tomato#6966 | https://discord.gg/MrMap0
 * @INFO
 * Work for MrMap0 Development | https://MrMap0.dev
 * @INFO
 * Please mention him / MrMap0 Development, when using this Code!
 * @INFO
 */
